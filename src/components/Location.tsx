...
export function Location() {
  ...
  return (
    <section className="pt-28 pb-20 md:py-32 px-4 md:px-8 bg-[#0A0A0A]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mb-6 text-[#A5825B]">
              ...
              <span className="text-base font-medium tracking-[0.2em] uppercase" style={{ fontFamily: "Helvetica, Arial, sans-serif" }}>
                Localização
              </span>
            </div>
            ...
            <h2
              className="text-gradient-gold text-[14vw] md:text-[52px] font-bold mb-4 uppercase leading-none"
            ...
            <div
              className="text-[#D9D9D9] text-[22px] mb-10 leading-relaxed flex flex-col gap-3"
            ...
            <div className="flex items-start gap-4 mb-10">
              ...
              {/* Address Content */}
              <div>
                <span className="block text-base font-medium tracking-[0.15em] uppercase mb-2 text-white/50" style={{ fontFamily: "Helvetica, Arial, sans-serif" }}>
                  Endereço
                </span>
                <div className="flex items-start gap-2">
                  <p className="text-[#D9D9D9] text-xl leading-relaxed">
            ...
            {/* Navigation Buttons */}
            <div className="flex gap-4 w-full lg:w-[340px]">
              {/* Google Maps Button - Primary (Solid) */}
              <a
                href={mapsUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="flex-[1.15] flex justify-center items-center gap-2 px-4 py-3 rounded-lg text-lg md:text-lg font-medium transition-all duration-200 bg-[#A5825B] hover:bg-[#B8956A] text-[#0A0A0A] text-center whitespace-nowrap"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 flex justify-center items-center gap-2 px-4 py-3 rounded-lg text-lg md:text-lg font-medium transition-all duration-200 border border-[#A5825B]/50 hover:border-[#A5825B] text-[#A5825B] hover:text-[#F3DBB7] text-center whitespace-nowrap"
              >
          ...
          <div>
             <MapEmbed className="hidden lg:block h-full w-full object-cover" />
          </div>
